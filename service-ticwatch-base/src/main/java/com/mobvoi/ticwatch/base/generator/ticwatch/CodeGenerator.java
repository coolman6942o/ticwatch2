package com.mobvoi.ticwatch.base.generator.ticwatch;
...
//        // 公共父类
//        strategy.setSuperControllerClass("com.mdl.hundun.demo.BaseController");
//      // 写于父类中的公共字段
//      strategy.setSuperEntityColumns("id", "create_time", "update_time", "is_deleted");
//      strategy.setSuperEntityClass("com.mobvoi.zhaopin.console.fn.demo.BaseEntity");
